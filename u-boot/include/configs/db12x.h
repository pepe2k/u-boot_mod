...
#elif defined(CONFIG_FOR_DLINK_DAP1533)

	#define CONFIG_QCA_GPIO_MASK_LED_ACT_L	GPIO12 | GPIO14  | GPIO19  |\
						GPIO22
	#define CONFIG_QCA_GPIO_MASK_OUT	CONFIG_QCA_GPIO_MASK_LED_ACT_L
	#define CONFIG_QCA_GPIO_MASK_IN		GPIO11 | GPIO16 | GPIO17 | GPIO18
	#define CONFIG_QCA_GPIO_MASK_OUT_INIT_H	CONFIG_QCA_GPIO_MASK_LED_ACT_L
 ...
 */
	...
	#define CONFIG_BOOTARGS	"console=ttyS0,115200 root=31:03 mem=128M "\
				"rootfstype=squashfs,jffs2 init=/sbin/init "\
				"mtdparts=ath-nor0:128k(u-boot),64k(nvram),7680k(linux4),6528k@0x00150000(rootfs)"\
				",192k(LANG),64k(MAC),64k(ART)"
 ...
 */
	...
	#define OFFSET_MAC_DATA_BLOCK_LENGTH	0x010000
	#define OFFSET_MAC_ADDRESS		0x00FFA0
	#define OFFSET_MAC_ADDRESS2		0x00FFB4
	#define MAC_ADDRESS_TYPE_STR	1
#else
...
#define CONFIG_QCA_PLL	QCA_PLL_PRESET_550_400_200
    ...
    defined(CONFIG_FOR_DLINK_DAP1533)
