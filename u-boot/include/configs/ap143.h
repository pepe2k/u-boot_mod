 ...
 */
	...
	#define CONFIG_QCA_GPIO_MASK_LED_ACT_L	GPIO4  | GPIO11 | GPIO12 |\
      ...
      defined(CONFIG_FOR_QCA_AP143_16M)
 ...
 */
	...
	#define CONFIG_BOOTARGS	"console=ttyS0,115200 "\
				"rootfstype=squashfs init=/sbin/init "\
				"mtdparts=spi0.0:256k(u-boot)ro,64k(u-boot-env)ro,6336k(rootfs),1472k(kernel),64k(art)ro,7744k@0x50000(firmware)"

#elif defined(CONFIG_FOR_QCA_AP143_16M)
