...
CPPFLAGS	:=
AFLAGS		:=
CFLAGS		:= -Os -ggdb3 -Wall -Wextra -Wno-unused-parameter -Wno-sign-compare -Wstrict-prototypes $(cc-option,-Wshift-overflow=2) -ffunction-sections -flto=1 -flto-partition=1to1
