...
#define AG7240_ETH_CFG_RMII_GE0         BIT(10)
#define AG7240_ETH_CFG_RMII_HISPD_GE0   BIT(11)
#define AG7240_ETH_CFG_RMII_MASTER_MODE BIT(12)
...
#define AG7240_ETH_CFG_RXD_DELAY	BIT(14)
#define AG7240_ETH_CFG_RDV_DELAY        BIT(16)
